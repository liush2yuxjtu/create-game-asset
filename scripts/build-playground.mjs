...
const paths=[];
function walk(dir){for(const e of readdirSync(dir,{withFileTypes:true})){const p=join(dir,e.name).replaceAll('\\','/');if(p==='public/games')continue;if(e.isDirectory())walk(p);else if(p.endsWith('.js'))paths.push(p);}}
